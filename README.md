...
На десятку достаточно решить 25 задач.
...
Ко всем функциям строго желательно писать юнит-тесты и проперти. В качестве юнит-тестов можно брать проперти без параметров.
